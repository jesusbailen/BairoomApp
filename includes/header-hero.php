...
$hero_image = $hero_image ?? "img/index.webp";
$hero_alt = $hero_alt ?? "Bairoom";
$active = $active ?? "";
$hero_class = $hero_class ?? "";
$has_hero_image = trim((string) $hero_image) !== '';
...
?>
<header class="hero-bairoom <?php echo $hero_class; ?>" style="<?php echo $has_hero_image ? "background-image: url('" . bairoom_url($hero_image) . "');" : "background-image: none;"; ?>">
  <div class="hero-video-wrapper" style="<?php echo $has_hero_image ? "background-image: url('" . bairoom_url($hero_image) . "');" : "background-image: none;"; ?>">
    <?php if ($has_hero_image): ?>
      <img class="hero-video" src="<?php echo bairoom_url($hero_image); ?>" alt="<?php echo $hero_alt; ?>" />
    <?php endif; ?>
  </div>
